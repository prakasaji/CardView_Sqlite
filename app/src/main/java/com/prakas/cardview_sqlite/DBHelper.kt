package com.prakas.cardview_sqlite
...
class DBHelper(context: Context): SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    companion object {
        ...
        private val SQL_CREATE_ENTRIES =
            "CREATE TABLE " + DBInfo.UserInput.TABLE_NAME + " (" + DBInfo.UserInput.COL_EMAIL + " VARCHAR(200) PRIMARY KEY, " + DBInfo.UserInput.COL_PASS + " TEXT, " +
